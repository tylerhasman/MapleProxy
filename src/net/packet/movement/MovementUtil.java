...
public class MovementUtil {
	...
	public static List<LifeMovementFragment> parseMovement(ByteBuf lea) {
    ...
    public static void updatePosition(List<LifeMovementFragment> movement, MapleMapObject target, int yoffset) {
        for (LifeMovementFragment move : movement) {
            if (move instanceof LifeMovement) {
                if (move instanceof AbsoluteLifeMovement) {
                    Point position = ((LifeMovement) move).getPosition();
                    position.y += yoffset;
                    target.positionUpdate(position);
                }
